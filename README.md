...
- 🐷🤖 **Boot Camp** — the Army of Lawnmower Vacuums & Flying Pigs side-scroller now lives
  on Kelly's own site at [kellylucas.dev/army.html](https://kellylucas.dev/army.html)
  (still linked from the setup screen; the old `/army.html` here redirects)
